#include "components/brightness/FindPhoneController.h"
#include <hal/nrf_gpio.h>
#include "displayapp/screens/Symbols.h"
#include "drivers/PinMap.h"
using namespace Pinetime::Controllers;

void FindPhoneController::Init() {
...
void FindPhoneController::Set(FindPhoneController::Levels level) {
  this->level = level;
  switch (level) {
    default:
    case Levels::High:
...
void FindPhoneController::FindPhone() {
  switch (level) {
    case Levels::High:
      Set(Levels::Medium);
      break;
...
void FindPhoneController::Higher() {
  switch (level) {
    case Levels::Off:
      Set(Levels::Low);
      break;
...
FindPhoneController::Levels FindPhoneController::Level() const {
  return level;
}

void FindPhoneController::Step() {
  switch (level) {
    case Levels::Low:
      Set(Levels::Medium);
      break;
...
const char* FindPhoneController::GetIcon() {
  switch (level) {
    case Levels::Medium:
...
const char* FindPhoneController::ToString() {
  switch (level) {
    case Levels::Off:
      return "Off";
    case Levels::Low:
